    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="blog-box-inner">
              <div className="blog-img-box">
                <img className="img-fluid" src="images/blog-img-04.jpg" alt="" />
              </div>
              <div className="blog-detail">
                <h4>Duis feugiat neque sed dolor cursus.</h4>
                <ul>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="blog-box-inner">
              <div className="blog-img-box">
                <img className="img-fluid" src="images/blog-img-05.jpg" alt="" />
              </div>
              <div className="blog-detail">
                <h4>Duis feugiat neque sed dolor cursus.</h4>
                <ul>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="blog-box-inner">
              <div className="blog-img-box">
                <img className="img-fluid" src="images/blog-img-06.jpg" alt="" />
              </div>
              <div className="blog-detail">
                <h4>Duis feugiat neque sed dolor cursus.</h4>
                <ul>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="blog-box-inner">
              <div className="blog-img-box">
                <img className="img-fluid" src="images/blog-img-07.jpg" alt="" />
              </div>
              <div className="blog-detail">
                <h4>Duis feugiat neque sed dolor cursus.</h4>
                <ul>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="blog-box-inner">
              <div className="blog-img-box">
                <img className="img-fluid" src="images/blog-img-08.jpg" alt="" />
              </div>
              <div className="blog-detail">
                <h4>Duis feugiat neque sed dolor cursus.</h4>
                <ul>
